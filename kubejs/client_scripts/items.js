...
ItemEvents.tooltip((event) => {
  ...
  event.addAdvanced(["kubejs:token_melee"], (item, advanced, text) => {
    text.add(1, [
      Text.of(
        "Right clik to reset your Skill Tree and chose the Melee Class "
      ).darkRed(),
    ]);
  });
  event.addAdvanced(["kubejs:token_ranged"], (item, advanced, text) => {
    text.add(1, [
      Text.of(
        "Right clik to reset your Skill Tree and chose the Ranged Class "
      ).darkRed(),
    ]);
  });
  event.addAdvanced(["kubejs:token_mage"], (item, advanced, text) => {
    text.add(1, [
      Text.of(
        "Right clik to reset your Skill Tree and chose the Mage Class "
      ).darkRed(),
    ]);
  });
});
